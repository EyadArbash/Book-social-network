...
import { updateArchivedeStatus } from '../fn/book/update-archivede-status';
import { UpdateArchivedeStatus$Params } from '../fn/book/update-archivede-status';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `updateArchivedeStatus()` */
  static readonly UpdateArchivedeStatusPath = '/books/archived/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `updateArchivedeStatus()` instead.
   *
   * This method doesn't expect any request body.
   */
  updateArchivedeStatus$Response(params: UpdateArchivedeStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return updateArchivedeStatus(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `updateArchivedeStatus$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  updateArchivedeStatus(params: UpdateArchivedeStatus$Params, context?: HttpContext): Observable<number> {
    return this.updateArchivedeStatus$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
