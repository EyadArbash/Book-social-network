package com.eyad.book.book;

import com.eyad.book.common.PageResponse;
...
public class BookController {
    ...
    public ResponseEntity<PageResponse<BorrowedBookResponse>> findAllBorrowedBooks(
        ...
        return ResponseEntity.ok(service.findAllBorrwedBooks(page, size, connectedUser));
    }
    ...
    public ResponseEntity<Integer> updateArchivedeStatus(
            @PathVariable("book-id") Integer bookId,
            Authentication connectedUser
    ) {
    ...
    public ResponseEntity<Integer> approveReturnBook(@PathVariable("book-id") Integer bookId, Authentication connectedUser) {
