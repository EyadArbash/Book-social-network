package com.eyad.book.feedback;

import com.eyad.book.book.Book;
import com.eyad.book.book.BookRepository;
...
public class FeedbackService {
    ...
    public Integer save(FeedbackRequest request, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("You can not give a feedback if you are archived");
        }
